...
function _ferret_scripts()
{
    ...
    wp_enqueue_style('_ferret-style-base', ___ferret_theme_uri__.'/assets/css/dooioomoo.min.css');
    wp_enqueue_style('_ferret-style-customize', ___ferret_theme_uri__.'/assets/css/custom.min.css');

    wp_enqueue_style( '_ferret-style', get_stylesheet_uri() );
    /**
     * scripts
     */
    wp_enqueue_script('_ferret-navigation-js', ___ferret_theme_uri__ . '/assets/js/navigation.minjs', array(), ___ferret_theme_ver__, true);
